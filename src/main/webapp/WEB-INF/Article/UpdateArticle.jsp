            ...
            <figure>
                <fieldset>
                    ...
                    <form action="UpdateArticle" method="post" class="containerColunm" >
                        ...
                        <label for="moderation">Modération : $(article.medere)</label> 
                        <select  name="modere" class="containerColumn select">
                          
                           <option value="${article.modere?'moderé':''} }">moderé</option>
                           <option value="${article.modere?'':'en attente'} }">en attente</option>
