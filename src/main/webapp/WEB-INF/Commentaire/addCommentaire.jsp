   ...
   <jsp:include page="../HeaderConnecte.jsp" />
    <section>
        ...
        <div class="formulaire">
             <figure>
                <fieldset>
                    <legend>Ecrivez votre commentaire : </legend>
                    
                    <form action="AddCommentaire" method="post" class="containerColunm" >
                    	<input type="hidden"  name="id"  value="${compte.compte }"/>
                    	
                    	<input type="hidden" name ="idArt" value="${idArt }">
                    	<label for="contenu"> Votre commentaire * :   </label> <input type="text" id="contenu" name="contenu" required>
